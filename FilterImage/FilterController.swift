...
class FilterController: UIViewController {
    ...
    private func setupFilters() {
        ...
        filterParamViewDict["CICircularScreen"] = CICircularScreenParamView(frame: CGRect.zero)
        filterParamViewDict["CICMYKHalftone"] = CICMYKHalftoneParamView(frame: CGRect.zero)
