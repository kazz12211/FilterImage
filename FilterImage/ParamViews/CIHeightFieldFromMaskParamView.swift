//
//  CIHeightFieldFromMaskParamView.swift
//  FilterImage
//
...
class CIHeightFieldFromMaskParamView: FilterParamView {
    ...
    override func setupSubviews() {
        ...
        rect = CGRect(x: inputRadiusLabel.frame.origin.x + inputRadiusLabel.frame.width, y: inputRadiusLabel.frame.origin.y, width: self.frame.width - (inputRadiusLabel.frame.origin.x + inputRadiusLabel.frame.width + 70), height: 29)
        inputRadiusSlider = UISlider(frame: rect)
        inputRadiusSlider.minimumValue = 0
        inputRadiusSlider.maximumValue = 300
        ...
        rect = CGRect(x: inputRadiusSlider.frame.origin.x + inputRadiusSlider.frame.width, y: inputRadiusLabel.frame.origin.y, width: 70, height: 29)
